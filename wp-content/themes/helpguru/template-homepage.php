...
<div class="ht-grid ht-grid-gutter-20">
	...
	<div class="ht-grid-col <?php echo $ht_hpf_col; ?>">
	<a href="https://forum.loojas.com.br/">
		<div class="hf-block hf-forum-block">
		<i class="fa fa-comments-o"></i>
		<h4><?php _e( 'Comunidade Loojas', 'ht-theme' ); ?></h4>
		<h5>A comunidade Loojas é um espaço de discussão gratuito e ela é aberta a todos os lojistas!</h5>
		<?php
		/**
